                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        echo "<tr '>
                                    ...
                                    <td> ";
                        if ($row['Status'] == 1) {
                            echo "<a href='adsshoworhide.php?ADS-ID={$row['AdsID']}' class='btn btn-danger ml-2  ' >Nonaktifkan</a>";
                        } else if ($row['Status'] == 0) {
                            echo "<a href='adsshoworhide.php?ADS-ID={$row['AdsID']}' class='btn btn-primary ml-2  ' >Aktifkan</a>";
                        }
                        echo "<a href='pageads.php?ADS-ID={$row['AdsID']}' class='btn btn-primary ml-2  ' >Halaman Iklan<a>
                        <a href='deleteads_admin.php?ADS-ID={$row['AdsID']}' class='btn btn-danger ml-2 ' >Hapus</a>
                        </td> 
                    ...
                    outputMessage("Iklan Tidak Tersedia", 'warning');
                }
                ?>
            </tbody>
        </table>
