...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/profilee_dashboard.css" />
</head>
    ...
    <section class="tabs px-5 pt-3 ">
        <div class="container">
            ...
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <h3 class="nav-link active" data-toggle="tab" href="">Dasboard</h3>
                </li>
            </ul>
            <div class="tab-content">
                <div class="tab-pane container active tab1" id="home">
                    <div class="profile">
                        <div class="porofil">
                            <a href="profile_user.php"><img class="porofil" src="assets/img/new.jpg"></a>
                        </div>
                        <div class="porofil">
                            <a href="profile_iklan.php"><img class="porofil" src="assets/img/rums.jpg"></a>
                        </div>
                    </div>
                </div>
            </div>
