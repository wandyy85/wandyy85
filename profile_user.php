...
<body>
    ...
    <section class="commercial-asd container">
        ...
        if ($is_exist > 0) {
            ...
            $_SESSION['id_user'] = $row['UserID']; // set session untuk id
        } else {
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" readonly name="UserName" class="form-control-plaintext" id="staticEmail" value="<?php echo $row['UserName']; ?>">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" readonly name="Email" class="form-control-plaintext" id="staticEmail" value="<?php echo $row['Email']; ?>">
                </div>
            </div>

            <div class="form-group row">
                <label for="staticEmail" class="col-sm-2 col-form-label">Nomer Telepon :</label>
                <div class="col-sm-10">
                    <input type="text" readonly name="Phone" class="form-control-plaintext" id="staticEmail" value="<?php echo $row['Phone']; ?>">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="password" readonly name="Password" class="form-control-plaintext" id="staticEmail" value="<?php echo $row['Password']; ?>">
                </div>
            </div>

            <a class="btn" href="profile_edit_user.php">Ubah Profile</a>
        </form>
